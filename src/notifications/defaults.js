...
export const DEFAULT_ROUTING = {
    // Clinical alarms render in the in-monitor strip directly below the RESP
    // wave (see PatientMonitor.jsx). The global top BannerSurface is reserved
    // for system messages, not patient alarms.
    [`${SOURCES.CLINICAL}/${SEVERITY.CRITICAL}`]: [SURFACES.AUDIO, SURFACES.HISTORY, SURFACES.BACKEND],
    [`${SOURCES.CLINICAL}/${SEVERITY.ERROR}`]: [SURFACES.AUDIO, SURFACES.HISTORY, SURFACES.BACKEND],
    [`${SOURCES.CLINICAL}/${SEVERITY.WARNING}`]: [SURFACES.AUDIO, SURFACES.HISTORY, SURFACES.BACKEND],

// The portability gate on rohy's VENDORED copy of the cardoyon package.
//
// Upstream is ~/Documents/Github/ECG (its own repo, its own test suite). This
// folder is a byte-identical copy of its src/ — INTEGRATION.md — plus this
// file and README.md.
...
//
// Same posture as the pathology and pacs gates: react-i18next inside the
// package would compile everywhere and throw at render outside an
...
const PEER_DEPENDENCIES = new Set(['react']);
...
describe('ecg package portability', () => {

...
const TnaCentralityTable = ({ centralityData, colorMap }) => {
  ...
  return <div className="overflow-x-auto">
    ...
    key={key}
    className="text-right py-2 px-3 font-medium text-neutral-300 cursor-pointer hover:text-gray-900 dark:hover:text-white select-none"
  ...
  >
        ...
        <tbody>
          {sorted.map(({ label, values }) => <tr key={label} className="border-b border-neutral-800 hover:bg-neutral-800/50">
              <td className="py-1.5 px-3 flex items-center gap-2 text-neutral-100">
                <span
  ...
  />
              ...
              {availableMeasures.map(({ key }) => <td key={key} className="text-right py-1.5 px-3 tabular-nums text-neutral-400">

...
| `OPENAI_API_KEY` | No | — | OpenAI API credential (LLM / TTS). **⚠ secret — see security note above.** | `server/routes/admin-routes.js:1714`<br>`server/routes/admin-routes.js:1715`<br>`server/routes/proxy-routes.js:394`<br>_+2 more_ |

...
just looking at the strategy or how it was designed, see the
...
the contract probe doesn't read data, it just needs to pass
...
code can't read the new schema. Use `rohy-update restore-backup <snapshot>`
...
what you're about to install manually:

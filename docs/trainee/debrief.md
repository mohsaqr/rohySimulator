...
The **Consultant** room is where you reflect on the case after it ends. You
...
- the patient's timeline stops advancing,
- chat, exams and orders are locked,
...
3. You are taken into the **Consultant** room with the case marked ended.
...
- Open the patient/case **summary** to see a consolidated view of the
  encounter.
- **Back to Cases** returns you to the patient screen. On an ended case the
  case stays closed.

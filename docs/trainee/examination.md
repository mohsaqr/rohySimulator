...
map of the patient and a panel for the findings. Switching here does not end
your session or lose your chat.
...
2. **Choose an examination type** for that region. The available types are:
   ...
   - **Auscultation**
   - **Special Tests**
3. The **finding** for that region and exam type appears in the findings
   panel. For auscultation, listenable audio plays where the case provides
   it.

Each region-and-type you perform is recorded in the exam log so you can see
...
Use the **Notes** button at the top of the Examination room to jot your
findings as you go. These notes are saved with the session and are available
again in the [debrief](/trainee/debrief).

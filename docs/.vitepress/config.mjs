      ...
      '/trainee/': [
        {
          ...
          items: [
            ...
            { text: 'Reading a pathology slide', link: '/trainee/pathology' },
            { text: 'The PACS reading room', link: '/trainee/imaging-reading-room' },
            ...
            { text: 'Courses, lessons & surveys', link: '/trainee/courses' },
